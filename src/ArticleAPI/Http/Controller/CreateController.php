...
class CreateController implements TokenAuthenticatedController
{
    ...
    public function action(Request $request)
    {
        ...
        try {
            $command = new CreateArticleCommand($payload['title'], $payload['body']);
            $this->commandBus->handle($command);

            return $this->dataFormatter->format($acceptHeader, ['message' => 'Article successfully created'], Response::HTTP_OK);
        } catch (\Exception $e) {
